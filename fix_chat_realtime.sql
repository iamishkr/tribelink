-- ====================================================================
-- TribeLink — Fix Realtime Chat & Message Subscriptions
-- Run this script in your Supabase SQL Editor to enable Realtime messaging, triggers, and bucket policies
-- ====================================================================
